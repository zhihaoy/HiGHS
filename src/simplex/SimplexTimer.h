...
void NWinitialiseDualSimplexClocks(HighsModelObject & model_object) {
  ...
  simplex.clock_[DevexIzClock] = timer.clockDef("UPDATE_WEIGHT", "UPW");
  simplex.clock_[UpdateWeightClock] = timer.clockDef("DEVEX_IZ", "DIZ");
...
void NWreportDualSimplexIterateClock(HighsModelObject & model_object) {
...
void NWreportDualSimplexInnerClock(HighsModelObject & model_object) {
  std::vector<int> simplexClockList{
...
void NWreportDualSimplexOuterClock(HighsModelObject & model_object) {
  std::vector<int> simplexClockList{
